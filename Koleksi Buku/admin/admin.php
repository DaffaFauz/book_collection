...
<html lang="en">
  ...
  if(isset($_SESSION['alert'])== "tambah"){
    ...
    <main>
      <div id="content">
        <article>
          <header>
            <h2>Data Admin Perpustakaan</h2>
            <div class="search">
              <input type="text" name="search" id="search" placeholder="Masukkan nama" />
              <a href="tambah/tambah_admin.php"><i class="fa-solid fa-plus"></i> Tambah Data Admin</a>
            </div>
          </header>
          <section id="hasil">
            <table>
              ...
              <tr>
                ...
                <td align="center">
                  <a class="edit" href="edit/edit_admin.php?id=<?php echo $d['id'];?>"><i class="fa-solid fa-pen-to-square"></i></a> | <a class="delete" href="delete/delete_admin.php?id=<?php echo $d['id'];?>" name="delete"><i class="fa-solid fa-trash"></i></a>
                </td>
              </tr>
              <?php } ?>
            </table>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    function load_data(search){
      $.ajax({
        url:"../assets/script/ajax/get_data_admin.php",
        method:"POST",
        data: {
          search: search
        },
